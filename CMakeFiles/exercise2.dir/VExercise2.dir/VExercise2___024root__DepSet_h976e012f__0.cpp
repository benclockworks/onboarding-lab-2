...
VL_INLINE_OPT void VExercise2___024root___ico_sequent__TOP__0(VExercise2___024root* vlSelf) {
    ...
    if (((IData)(vlSelf->nReset) ^ (IData)(vlSelf->Exercise2__DOT____Vtogcov__nReset))) {
        vlSymsp->__Vcoverage[1].fetch_add(1, std::memory_order_relaxed);
        vlSelf->Exercise2__DOT____Vtogcov__nReset = vlSelf->nReset;
    }
    ...
    vlSelf->out = ((0xfffeU & (IData)(vlSelf->out)) 
                   | (1U & VL_REDXOR_16((0xb400U & (IData)(vlSelf->init)))));
