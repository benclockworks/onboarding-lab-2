...
#endif
                VL_FATAL_MT("/Users/benchikbayor/Desktop/onboarding-lab-2/rtl/Exercise3.sv", 7, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void VExercise3___024root___ctor_var_reset(VExercise3___024root* vlSelf) {
    ...
    vlSelf->Exercise3__DOT__mys1out1 = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT__mys1out2 = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT____Vcellinp__theGamma__b_in = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT____Vcellinp__theGamma__a_in = VL_RAND_RESET_I(8);
    ...
    vlSelf->Exercise3__DOT____Vtogcov__mys1out1 = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT____Vtogcov__mys1out2 = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT____Vtogcov__mys2In1 = VL_RAND_RESET_I(16);
    vlSelf->Exercise3__DOT____Vtogcov__mys2In2 = VL_RAND_RESET_I(16);
    vlSelf->Exercise3__DOT__theGamma__DOT__count = VL_RAND_RESET_I(2);
    vlSelf->Exercise3__DOT__theGamma__DOT____Vtogcov__a_in = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT__theGamma__DOT____Vtogcov__b_in = VL_RAND_RESET_I(8);
    vlSelf->Exercise3__DOT__theGamma__DOT____Vtogcov__count = VL_RAND_RESET_I(2);
